...
public class DiarySiteAdapter extends BaseAdapter {
	private ArrayList<Diary> diary_list;
	private LayoutInflater inflater;

	public DiarySiteAdapter(Context context, ArrayList<Diary> diary_list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_site_layout, null);
		...
		holder.diarySite.setText(diary.getDiarySite());
